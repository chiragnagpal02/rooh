...
const NAV_ITEMS: {
...
}[] = [
  {
    ...
    label: "Memories",
    description:
      "All voice notes your parent has recorded — transcribed, summarised, and searchable.",
    icon: (
  ...
  },
  {
    ...
    label: "Info",
    description:
      "Key practical details extracted from recordings — insurance, bank info, property, and contacts.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        <rect
          x="2"
  ...
  },
  {
    ...
    label: "Health",
    description:
      "Doctors, medicines, symptoms, and appointments — automatically tracked from voice notes.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        <path
          d="M8 2a4 4 0 00-4 4c0 3 4 8 4 8s4-5 4-8a4 4 0 00-4-4z"
          stroke="currentColor"
          strokeWidth="1.5"
  ...
  },
  {
    ...
    label: "Prompts",
    description:
      "Send your parent a gentle question on WhatsApp to inspire their next memory.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        <path
  ...
  },
  {
    ...
    label: "Family",
    description:
      "Manage connected parents and invite family members to share the archive.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
  ...
  },
  {
    ...
    label: "Settings",
    description:
      "Manage your notification preferences, WhatsApp number, and account details.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
...
export default function LayoutShell({
  ...
  return (
    <>
      ...
      <div
        style={{ display: "flex", minHeight: "100vh", background: "#FDF8F3" }}
      >
        {/* ── Desktop Sidebar ── */}
        <div
        ...
        >
          ...
          <div
            style={{ padding: "12px 8px", borderTop: "0.5px solid #2C2926" }}
          >
            <button
        ...
        >
          ...
          >
            ...
            {view === "health" && (
              <HealthView recordings={recordings} parents={parents} />
            )}
            ...
            {NAV_ITEMS.map((item) => (
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "10px",
                    fontWeight: view === item.key ? 500 : 400,
                  }}
                >
                  {item.label}
                </span>

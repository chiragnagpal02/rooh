    ...
    <div>
      {!checklistDismissed && (
        <GettingStartedChecklist
          parentName={parents[0]?.name || "your parent"}
          ...
          {filtered.map((recording) => {
            ...
            return (
              ...
              >
                <button
                  onClick={() =>
                    handleExpand(recording.id, (recording as any).is_new)
                  }
                  style={{
                    width: "100%",
                    textAlign: "left",
                  ...
                  >
                    ...
                    {recording.primary_type === "legacy" && (
                      ...
                      >
                        ...
                        >
                          This is a personal message kept in{" "}
                          {recordingParentName}'s exact words.
                        </p>
                      </div>
                    )}
                    ...
                    {reactionSuccess === recording.id && (
                      ...
                      >
                        ...
                        >
                          🙏 {recordingParentName.split(" ")[0]} will be
                          notified of your reaction.
                        </p>
                      </div>
                    )}
                    ...
                    {!isReacting ? (
                      ...
                      >
                        <span style={{ fontSize: "14px" }}>🙏</span> React to
                        this memory
                      </button>
                    ) : (
                      <div
                      ...
                      >
                              ...
                              style={{
                                ...
                                border:
                                  selectedEmoji === emoji
                                    ...
                                    : "0.5px solid #E8E0D5",
                                background:
                                  selectedEmoji === emoji ? "#F0FAF6" : "white",
                                cursor: "pointer",
                                display: "flex",
                                alignItems: "center",
                        ...
                        <div style={{ display: "flex", gap: "8px" }}>
                          ...
                          >
                            {submittingReaction
                              ? "Sending..."
                              : `Send ${selectedEmoji} to ${recordingParentName.split(" ")[0]}`}
                          </button>
                        </div>
                      </div>
                    )}

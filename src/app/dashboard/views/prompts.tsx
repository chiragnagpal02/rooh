...
export default function PromptsView({ userEmail }: Props) {
  const [activeTab, setActiveTab] = useState<"next" | "schedule" | "history">(
    "next",
  );
  ...
  // Add this alongside your existing useStates
  useEffect(() => {
    ...
    <div>
      ...
      {activeTab === "next" && (
        <div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Sending this {selectedDay === "Sun" ? "Sunday" : selectedDay}{" "}
                  · {selectedTime} IST
                </p>
          ...
          >
            <p style={{ fontSize: "13px", color: "#085041", margin: 0 }}>
              This prompt will be sent to your parent on WhatsApp. They just
              need to press and hold the microphone button to reply.
            </p>
          </div>
        </div>
      )}
            ...
            history.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "14px 20px",
                  borderBottom:
                    i < history.length - 1 ? "0.5px solid #F5F0EA" : "none",
                }}
              >
                <span
                  style={{

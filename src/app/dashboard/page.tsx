        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            ...
            },
            {
              ...
              value: recordings.filter(
                (r) =>
                  r.primary_type === "practical" || r.primary_type === "mixed",
              ).length,
            },
          ].map((stat) => (
            <div
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium ${TYPE_COLORS[recording.primary_type]}`}
                        >
                  ...
                  <div className="px-4 pb-4 border-t border-gray-50 pt-3 space-y-3">
                    ...
                    {recording.needs_review && (
                      <p className="text-xs text-amber-600 bg-amber-50 px-3 py-2 rounded-lg">
                        This recording needs manual review — classification
                        confidence was low.
                      </p>
                    )}
                  </div>
